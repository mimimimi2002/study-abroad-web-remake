...
const obj = {
  ...
  if(obj[myParam].length == 0){
    ...
    /*
    if(preParam == "P"){
      backDiv.href = "period.html" + "?"+ "param=" +myParam.substring(0,myParam.length-2);
      backDiv.textContent = '一つ前のページに戻る';

    }
    else if(preParam == "E"){
      backDiv.href = "event.html" + "?"+ "param=" +myParam.substring(0,myParam.length-2);
      backDiv.textContent = '一つ前のページに戻る';
    }
    else if(preParam == "e"){
      backDiv.href = "event.html" + "?"+ "param=" +myParam.substring(0,myParam.length-2);
    ...
    buttonBack.appendChild(backDiv);


    var startDiv = document.createElement("a");
    startDiv.href = "homepage.html";
    startDiv.textContent = '最初に戻る';

    var buttonStart = document.createElement("button");
    buttonStart.appendChild(startDiv);
    */
